...
from articles.web.views import ArticlesListView, ArticleCreateView, SourceCreateView, SourceDetailView, SourcesListView
...
urlpatterns = (
    ...
    path('sources/<int:pk>', SourceDetailView.as_view(), name='details source'),
)
